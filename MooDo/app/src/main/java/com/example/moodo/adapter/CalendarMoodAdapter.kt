...
import com.example.moodo.databinding.ItemCalendarMoodBinding
import com.example.moodo.databinding.ItemStatisBinding
import com.example.moodo.db.MooDoMode
import java.text.SimpleDateFormat
import java.util.Locale

class CalendarMoodAdapter():RecyclerView.Adapter<CalendarMoodAdapter.MoodHolder>() {
    var moodList = mutableListOf<MooDoMode>()
    ...
    inner class MoodHolder(val binding: ItemCalendarMoodBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoodHolder {
        return MoodHolder(ItemCalendarMoodBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
